...
public class Ej3 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Alumnos> alum = sv.crearAlumno();

        System.out.println("Ingrese el nombre del estudiante que desea buscar: ");
        String nombre = leer.next();
        boolean aux = false;
        for (Alumnos arg : alum) {
            if (arg.getNombre().equalsIgnoreCase(nombre)) {
//                sv.notaFinal(arg.getListaNotas());
                System.out.println("La nota final del alumno es: " + sv.notaFinal(arg.getListaNotas()));
                aux = true;
            }
